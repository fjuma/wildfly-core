...
package org.jboss.as.test.integration.security.ssl.openssl;
...
public class OpenSslTlsTestCase {
    ...
    private static final String[] SERVER_KEY_STORE = {"subsystem", "elytron", "key-store", "LocalhostKeyStore"};
    ...
    private static final String[] CLIENT_KEY_STORE = {"subsystem", "elytron", "key-store", "FireflyKeyStore"};
    ...
    private static File localhostKeystore;
    private static File fireflyKeystore;
    ...
    private static void setUpKeyStores() throws Exception {
        trustStore = File.createTempFile("ca", ".truststore");
        fireflyKeystore = File.createTempFile("firefly", ".keystore");
        localhostKeystore = File.createTempFile("localhost", ".keystore");
