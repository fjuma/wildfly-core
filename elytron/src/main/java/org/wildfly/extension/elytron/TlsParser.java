...
class TlsParser {
    ...
    private PersistentResourceXMLBuilder keyManagerParser_11_0 = PersistentResourceXMLDescription.builder(PathElement.pathElement(KEY_MANAGER))
            .setXmlWrapperElement(KEY_MANAGERS)
            .addAttribute(SSLDefinitions.ALGORITHM)
            .addAttribute(SSLDefinitions.KEYSTORE)
            .addAttribute(SSLDefinitions.ALIAS_FILTER)
            ...
            .addAttribute(SSLDefinitions.PROVIDER_NAME)
            .addAttribute(CredentialReference.getAttributeDefinition())
            .addAttribute(SSLDefinitions.GENERATE_SELF_SIGNED_CERTIFICATE_HOST);
    ...
    final PersistentResourceXMLDescription tlsParser_11_0 = decorator(TLS)
            ...
            .addChild(keyManagerParser_11_0)
            .addChild(trustManagerParser)
